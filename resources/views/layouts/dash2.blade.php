...
<body class="bg-gray-50">
            ...
            <div class="flex flex-col flex-grow pt-5 pb-4 overflow-y-auto">
                ...
                <div class="flex items-center justify-center flex-shrink-0 px-4 mb-6">
                    <a href="/" class="flex items-center">
                        <img src="{{ asset('/public/'.$settings->logo)}}" alt="Logo" class="h-10 w-auto">
                    </a>
                </div>
    ...
    <div class="flex-shrink-0 mr-3">
        @if(!empty(Auth::user()->profile_photo_path))
            <img src="{{ asset('public/' . Auth::user()->profile_photo_path) }}"
     alt="{{ Auth::user()->name }}"
            ...
            ID: {{ Auth::user()->usernumber }}
                ...
                <nav class="flex-1 px-4 space-y-1">
                    ...
                    <a href="{{ route('deposits') }}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg {{ request()->routeIs('deposits') ? 'bg-primary-50 text-black border-l-4 border-primary-500 pl-2' : 'text-gray-700 hover:bg-gray-50' }}">
                     ...
                     <a href="{{ route('mplans') }}" class="flex items-center px-3 py-2.5 text-sm font-medium rounded-lg {{ request()->routeIs('mplans') ? 'bg-primary-50 text-black border-l-4 border-primary-500 pl-2' : 'text-gray-700 hover:bg-gray-50' }}">
                        <i data-lucide="banknote-arrow-up" class="mr-3 h-5 w-5 {{ request()->routeIs('deposits') ? 'text-black' : 'text-gray-500' }}"></i>
                        Save and Invest
                    </a>
            ...
            <header class="bg-white shadow-sm z-20">
                <div class="flex items-center justify-between px-4 py-3">
                    ...
                    <div class="flex items-center md:hidden">
                        ...
                        <a href="/" class="ml-4">
                            <img src="{{ asset('/public/'.$settings->logo)}}" alt="Logo" class="h-8 w-auto">
                        </a>
                    </div>
...
>
    ...
    @if(!empty(Auth::user()->profile_photo_path))
        <img
            src="{{ asset('/public/photos/'.Auth::user()->profile_photo_path)}}"
            alt="{{ Auth::user()->name }}"
    ...
    @endif
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        ...
                        <a href="{{ route('deposits') }}" class="group">
                         ...
                         <a href="{{ route('mplans') }}" class="group">
                            <div class="aspect-square flex flex-col items-center justify-center rounded-xl bg-gradient-to-br from-primary-50 to-primary-100 hover:from-primary-100 hover:to-primary-200 transition-all duration-300 p-2">
                                <div class="h-10 w-10 rounded-full bg-white flex items-center justify-center mb-1 shadow-sm group-hover:shadow transition-all">
                                    <i data-lucide="banknote-arrow-up" class="h-5 w-5 text-black"></i>
                                </div>
                                <span class="text-xs font-medium text-gray-700">Save and Invest</span>
                            </div>
                        </a>
            ...
            <footer class="bg-white border-t border-gray-200 hidden md:block">
                <div class="max-w-7xl mx-auto py-4 px-4 sm:px-6 md:flex md:items-center md:justify-between">
                    <div class="flex items-center">
                        <img src="{{ asset('/public/'.$settings->logo)}}" alt="Logo" class="h-6 w-auto mr-2">
